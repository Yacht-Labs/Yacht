    ...
    <SafeAreaView style={[{ paddingTop: headerHeight }, styles.mainContainer]}>
      <ScrollView style={styles.topContainer}>
        <Text style={styles.topText}>
          This transaction will send {swapContext.chainAParams.amount} tokens to
          the swap PKP. Once the counterparty sends their{" "}
          {swapContext.chainBParams.amount} tokens to the swap PKP, your swap is
          ready.
        </Text>
        <YachtButton
          onPress={() => Clipboard.setString(swapContext.address)}
          style={styles.pkpCopyButton}
          textStyle={styles.pkpCopyButtonText}
          title={swapContext.address}
        />
        <View style={styles.figureContainer}>
          <Image
            style={styles.swapFigure}
            source={require("../assets/images/swapFigure1.png")}
          />
        </View>
        <Text style={styles.bottomText}>
          If the swap is not completed by the counterparty within 72 hours your
